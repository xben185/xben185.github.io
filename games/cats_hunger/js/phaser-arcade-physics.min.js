        ...
        window.console || (window.console = {}, window.console.log = window.console.assert = function() {}, window.console.warn = window.console.assert = function() {}), b.Circle = function(a, b, c) {
            ...
            showDebugHeader: function() {
                ...
                if (this.renderType === b.WEBGL ? (c = "WebGL", e++) : this.renderType == b.HEADLESS && (c = "Headless"), this.device.webAudio && (d = "WebAudio", e++), this.device.chrome) {
                    for (var f = ["%c %c %c Phaser v" + a + " | Pixi.js " + PIXI.VERSION + " | " + c + " | " + d + "  %c %c  http://phaser.io  %c %c ♥%c♥%c♥ ", "background: #0cf300", "background: #00bc17", "color: #ffffff; background: #00711f;", "background: #00bc17", "background: #0cf300", "background: #00bc17"], g = 0; 3 > g; g++) f.push(e > g ? "color: #ff2424; background: #fff" : "color: #959595; background: #fff");
            ...
            pollStatus: function() {
                if (!(!this.connected || this.game.input.disabled || this.game.input.gamepad.disabled || this._rawPad.timestamp && this._rawPad.timestamp === this._prevTimestamp)) {
                    ...
                    for (var c = 0; c < this._axesLen; c++) {
                        ...
                        this.processAxisChange(d > 0 && d > this.deadZone || 0 > d && d < -this.deadZone ? {
                            axis: c,
                            value: d
                        } : {
                            axis: c,
            ...
            connect: function(a) {
                ...
                for (var d in a.buttons) d = parseInt(d, 10), this._buttons[d] = new b.GamepadButton(this, d);
            ...
            copyPixels: function(a, c, d, e) {
                ...
                if (a instanceof b.Image || a instanceof b.Sprite) {
                    f = a.texture.baseTexture.source;
                    var i = a.texture.frame;
                    g = i.x, h = i.y
                } else a instanceof b.BitmapData && (f = a.canvas);
                this.context.drawImage(f, g + c.x, h + c.y, c.width, c.height, d, e, c.width, c.height), this.dirty = !0
            },
            draw: function(a, c, d, e, f) {
                "undefined" == typeof c && (c = 0), "undefined" == typeof d && (d = 0), "string" == typeof a && (a = this.game.cache.getImage(a));
                var g = a,
                    h = 0,
                    i = 0,
                    j = 0,
                ...
                if (a instanceof b.Image || a instanceof b.Sprite) {
                    ...
                    h = l.x, i = l.y, j = l.width, k = l.height
                } else a instanceof b.BitmapData && (g = a.canvas), j = a.width, k = a.height;
                "undefined" == typeof e && (e = j), "undefined" == typeof f && (f = k), this.context.drawImage(g, h, i, j, k, c, d, e, f), this.dirty = !0
            },
            ...
            calculateFaces: function(a) {
                if (this.preventingRecalculate === !0) return void(this.needToRecalculate[a] = !0);
